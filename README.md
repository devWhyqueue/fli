...
|------|------|-------------|
| Prompt | `search-direct-flight` | Build a direct-flight search prompt around `search_flights` |
| Prompt | `find-budget-window` | Build a flexible-date search prompt around `search_dates` |
| Resource | `resource://fli-mcp/configuration` | Return MCP defaults, config schema, and supported environment variables |
